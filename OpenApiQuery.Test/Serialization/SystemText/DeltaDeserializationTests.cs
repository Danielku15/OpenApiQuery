...
namespace OpenApiQuery.Test.Serialization.SystemText
{
    ...
    public class DeltaDeserializationTests : SerializationTestBase
    {
        ...
        [TestMethod]
        public async Task TestDeserialize_ObjectArrays()
        {
        }

        [TestMethod]
        public async Task TestDeserialize_ObjectArrays_Polymorphic()
        {
        }

        [TestMethod]
        public async Task TestDeserialize_NativeArrays()
        {
        }

        [TestMethod]
        public async Task TestDeserialize_Dictionary()
        {
        }
